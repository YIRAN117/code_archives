...
os.getcwd()
db = gffutils.create_db("/Users/yiranli/Desktop/paper_prep/lncRNA_intron_added.gff",dbfn="cpar_db",force=True,keep_order=True,merge_strategy='merge', sort_attribute_values=True)
